...
class BlockBasedTable : public TableReader {
 public:
  ...
  static Status BlockOpen(
      ...
      std::vector<size_t> _block_offset, std::vector<size_t> _block_size, int _block_id, std::string _dev_name, 
...
struct BlockBasedTable::BlockInfo {
  BlockInfo(int _block_id, std::vector<size_t> _block_offset, std::vector<size_t> _block_size){
        block_id = _block_id;
